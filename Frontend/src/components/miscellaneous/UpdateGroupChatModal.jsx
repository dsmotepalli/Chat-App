...
const UpdateGroupChatModal = () => {
  ...
  const handleRemove = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://chat-app-4fhq.onrender.com/api/chat/groupremove`,
        {
  ...
  const handleAddUser = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://chat-app-4fhq.onrender.com/api/chat/groupadd`,
        {
          chatId: selectedChat._id,
          userId: user1._id,
        },
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        "https://chat-app-4fhq.onrender.com/api/chat/rename",
        {
          chatId: selectedChat._id,
